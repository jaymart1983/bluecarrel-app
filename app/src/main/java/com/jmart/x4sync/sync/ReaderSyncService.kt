...
import com.jmart.x4sync.MainActivity
import com.jmart.x4sync.R
import com.jmart.x4sync.UiState
import com.jmart.x4sync.X4SyncApp
import com.jmart.x4sync.data.BleConnection
 ...
 * ([X4SyncApp.engine]); this only exists because Android freezes or kills a
...
class ReaderSyncService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val engine = (application as X4SyncApp).engine
