...
import com.jmart.x4sync.AppTab
import com.jmart.x4sync.FirmwarePhase
import com.jmart.x4sync.FirmwareProgress
import com.jmart.x4sync.MainViewModel
import com.jmart.x4sync.TransferProgress
import com.jmart.x4sync.UiState
import com.jmart.x4sync.data.BlePermissions
import com.jmart.x4sync.data.BookRow
import com.jmart.x4sync.data.ResumePrompt
import com.jmart.x4sync.data.Config
        ...
        Column(
            ...
            when (section) {
                ...
                SettingsSection.UPDATES -> {
                    Text(
                        "Installed: " + com.jmart.x4sync.BuildConfig.VERSION_NAME +
                ...
                SettingsSection.DIAGNOSTICS -> {
                    Text(
                        buildString {
                            append("App ").append(com.jmart.x4sync.BuildConfig.VERSION_NAME)
                            append(" (code ").append(com.jmart.x4sync.BuildConfig.VERSION_CODE).append(")\n")
