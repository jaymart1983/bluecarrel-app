...
import com.jmart.x4sync.sync.BackgroundPermissions
import com.jmart.x4sync.sync.BackgroundRequirement
import com.jmart.x4sync.ui.AppScaffold

class MainActivity : ComponentActivity() {

    /** The process-wide engine, NOT an Activity-scoped one -- see [X4SyncApp]. */
    private val vm: MainViewModel get() = (application as X4SyncApp).engine
